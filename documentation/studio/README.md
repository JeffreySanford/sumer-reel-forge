...
- [x] Remotion cinematic animation proof loops are implemented.
- [x] A complete 60-second Reel 1 Remotion animation draft has rendered through the studio worker.
...
- Animation work should preserve source text, approval state, auditability, and generated-asset review.
...
- [Cinematic animation pipeline](animation-pipeline.md)
- [Renderer operations](renderer-operations.md)
- [Quality, security, and audit plan](quality-security-audit.md)
