...
test('Shot 3 Level 2 dev loop stays focused, tolerates only the known milestone red, and can build blink plus combined preview in one command', async () => {
  ...
  assert.match(source, /--build-blink/);
  ...
  assert.match(source, /blink build: localized \+ generated \+ identity-QA \+ combined preview/);
